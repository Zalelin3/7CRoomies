...
def list_oncampuspost():
    ...
    if request.method == 'POST':
        ...
        P.description, P.capacity, P.owener_id, P.image_1, O.college, O.dorm_1,\
        ...
        if request.form['wakeup'] != "0":
            query = query +"AND U.waketime =" + request.form['wakeup']
        ...
        return render_template('home/oncamp.html', posts = posts, title = 'On Campus Filtering')
